...
openssl req -SHA-256 -nodes -newkey rsa:2048 -keyout client-key.pem -out client-req.pem -days 3650 -subj "/CN=MySQL_Server_8.0.36_Auto_Generated_Server_Certificate";
